...
<div class="bg-gray-200 text-white" style="font-family: Roboto Mono, monospace;">
      <!-- Sidebar -->
      <div class="flex h-screen relative">
        ...
        <div id="main" class="w-5/6 p-4 relative z-index-10 translate-x-[20%]">
            ...
            <div class="flex flex-col px-4 w-full  gap-4">
                  ...
                  <div class="container">
                    <div class="max-w-sm">
                      <div class="bg-white p-6 rounded-lg shadow-lg">
                        ...
                        <button type="button" onclick="document.getElementById('imageUpload').click()" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                          Choisir une image
                        </button>
                        <button type="button" id="addImage" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded ml-2">
                          Ajouter l'image
                        </button>
                        @error('image')
               ...
               <div class="flex flex-col gap-4">
                ...
                <div class="w-full justify-end flex px-8">
                  <button id="submit" type="submit" class="py-2 px-4 rounded-md text-[#ffffff] bg-green-950">Publier</button>
                </div>
                </form>
               </div>
            </div>
...
<script src="{{asset('js/eduposts.js')}}"></script>
@endsection